...
So if in future you needed to add new characters, then the newer characters aren’t all located at the end of *all* existing blocks while being separated from the rest of its similar characters. Imagine if we didn't reserve empty space and had the following ranges:
